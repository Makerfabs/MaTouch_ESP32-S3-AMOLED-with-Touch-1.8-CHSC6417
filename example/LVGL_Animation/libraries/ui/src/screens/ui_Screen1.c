...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label3, "Touch X:");
    ...
    lv_label_set_text(ui_Label8, "Y:");
    lv_obj_set_style_text_color(ui_Label8, lv_color_hex(0x8F8F8F), LV_PART_MAIN | LV_STATE_DEFAULT);
